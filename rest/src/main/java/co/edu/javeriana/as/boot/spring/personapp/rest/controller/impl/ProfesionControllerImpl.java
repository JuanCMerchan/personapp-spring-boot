...
import co.edu.javeriana.as.boot.spring.personapp.rest.adapter.ProfesionAppAdapter;
...
public class ProfesionControllerImpl implements ProfesionController {
    ...
    public List<ProfesionResponse> buscar() {
        ...
        return profesionRestMapper.fromListProfesionesToListProfesionesPostResponse(profesiones);
    }

    @Override
    @PostMapping
    public Boolean agregar(@RequestBody ProfesionRequest profesionPostRequest) {
        Profesion p = profesionRestMapper.fromProfesionPostRequestToProfesion(profesionPostRequest);
    ...
    @Override
    @PutMapping("/{id}")
    public Boolean actualizar(@PathParam("id") Integer id, @RequestBody ProfesionRequest profesionPostRequest) {
        Profesion p = profesionRestMapper.fromProfesionPostRequestToProfesion(profesionPostRequest);
    ...
    @Override
    @DeleteMapping("/{id}")
    public Boolean eliminar(@PathParam("id") Integer Cc) {
    ...
    @Override
    @GetMapping("/{id}")
    public ProfesionResponse consultar(@PathParam("id") Integer Cc) {
        Profesion pe = profesionAppAdapter.consultar(Cc, bandera);
        ProfesionResponse po = profesionRestMapper.fromProfesionToProfesionPostResponse(pe);
        return po;
    }
